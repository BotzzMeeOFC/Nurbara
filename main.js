...
const starts = async (ikyy = new WAConnection()) => {
	...
	console.log(color(figlet.textSync('PutraXd', {
	...
	console.log(color('[Scurity PutraXd]', 'cyan'), color('Owner is online now!', 'yellow'))

	console.log(color('[Scurity PutraXd]', 'cyan'), color('Welcome back, Owner! Hope you are doing well~', 'yellow'))

	ikyy.browserDescription = ["PUTRAXD - BOT", "Firefox", "3.0.0"];
	...
	ikyy.on('connecting', () => {
		...
		console.log(color('[ PUTRAXD OFC ]', 'cyan'), color('Menghubungkan....'));
	...
	ikyy.on('open', () => {
		...
		console.log(color('[ PUTRAXD OFC ]', 'cyan'), color('Bot Sudah Online!'));
