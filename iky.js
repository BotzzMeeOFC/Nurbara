      ...
      // GAME 
        ...
        if (game.isfam(from, family100)) {
          ...
          if (tebakata.hasOwnProperty(sender.split('@')[0]) && !isCmd) {
			...
			tc = `MAAF KA NOMER KAMU BLOM TERDAFTAR DI DATABASE SILAHKAN KETIK !verify UNTUK MENDAFTAR DI ʙᴏᴛᴢᴢ ᴍᴇᴇ`
			ind = {
			...
			/////
let ikyads = await getBuffer(`https://telegra.ph/file/1fb432bdf52c12d57eff3.jpg`)
fakelink = (tekslink) => { 
...
if (args.length < 1) return reply('Jumlahnya?')
		        try {
		        var hets = `Made-With-By-ʙᴏᴛᴢᴢ ᴍᴇᴇ`
	    ...
	    participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "62882248593508@s.whatsapp.net" } : {}) 
						...
						"surface": "CATALOG",
						"message": `ʙᴏᴛᴢᴢ ᴍᴇᴇ`,
						"orderTitle": `Made-With-By-ʙᴏᴛᴢᴢ ᴍᴇᴇ`,
 ...
 quoted: {
  ...
  message: {
   orderMessage: {
    ...
    surface: 1,
    message: `ʙᴏᴛᴢᴢ ᴍᴇᴇ`,
    orderTitle: `Made-With-By-ʙᴏᴛᴢᴢ ᴍᴇᴇ`, // Idk what this does
    sellerJid: '0@s.whatsapp.net' // Seller
   }
  }
 }
 ...
 quoted: {
  ...
  message: {
   orderMessage: {
    ...
    status: 1,
    surface: 1,
    message: `Made-With-By-ʙᴏᴛᴢᴢ ᴍᴇᴇ`,
    orderTitle: `ʙᴏᴛᴢᴢ ᴍᴇᴇ`, // 
    sellerJid: '0@s.whatsapp.net' // Seller
   }
  }
 }
...
if (args.length < 1) return reply('Jumlahnya?')
for (let i = 0; i < args[0]; i++) {
ikyy.sendMessage(from, `ʙᴏᴛᴢᴢ ᴍᴇᴇ`, MessageType.extendedText,{
 quoted: {
key: {
...
*𒆙* *Username:* ${pushname}
*𒆙* *Bio Info:* ${thu.status}
*𒆙* *Premium*: ${isPremium ? 'Ya' : 'No'}
*𒆙* *Admin*: ${isGroupAdmins ? 'Ya' : 'No'}
*𒆙* *Level*: ${Levelnye}
*𒆙* *XP*: ${Xpluu} / ${requiredXplu}

「 𝑩𝑶𝑻 𝑰𝑵𝑭𝑶𝑹𝑴𝑨𝑻𝑰𝑶𝑵 」

*𒆙* 𝐒𝐩𝐞𝐞𝐝 : *${latensie.toFixed(4)} _Second_*
*𒆙* 𝐀𝐜𝐭𝐢𝐯𝐞 : *${runtime(process.uptime())}*
*𒆙* 𝐏𝐥𝐚𝐭𝐟𝐨𝐫𝐦 : *${os.platform()}*
...
`
                    ...
                    ikyy.sendMessage(from, { contentText: `${menu}`, footerText: 'Made-With-By-ʙᴏᴛᴢᴢ ᴍᴇᴇ', buttons: [{ buttonId: `!command`, buttonText: { displayText: '📙MENU' }, type: 1 },{ buttonId: `!sewabot`, buttonText: { displayText: '🏷️ SEWA BOT' }, type: 1 },{ buttonId: `!patner`, buttonText: { displayText: '👥 PATNER' }, type: 1 } ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: ikyads, contextInfo: {mentionedJid: [sender]}}}, 'buttonsMessage')
              break
case 'f':
case 'lock':
 ikymemek = {
...
🔖 ${prefix}wallgravity text1 text2
 `
sendButMessage(from, wibu, `Made-With-By-ʙᴏᴛᴢᴢ ᴍᴇᴇ`, [
          {
            buttonId: `!menu`,
            buttonText: {
...
`
        ...
        case 'simi':
				...
				buttons = [{buttonId: `!infoig`,buttonText:{displayText: `Made-With-By-ʙᴏᴛᴢᴢ ᴍᴇᴇ`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'Made-With-By-ʙᴏᴛᴢᴢ ᴍᴇᴇ', imageMessage: imageMsg,
              contentText:`Made-With-By-ʙᴏᴛᴢᴢ ᴍᴇᴇ`,buttons,headerType:4}
...
`
 ...
 Made-With-By-ʙᴏᴛᴢᴢ ᴍᴇᴇ☕︎`, imageMessage: imageMsg,
               buttons: buttons,
               headerType: 1
}
...
`
 ...
 Made-With-By-ʙᴏᴛᴢᴢ ᴍᴇᴇ☕︎`, imageMessage: imageMsg,
   ...
   case 'command':
               list = []
               listmenu = [`groupmenu`,`photoxy`,`ephoto`,`randomimage`,`wibu2`,`storymenu`,`porno`,`randomtext`,`islammenu`,`wibumenu`,`stickermenu`,`ownermenu`,`gamemenu`,`funmenu`,`downloadmenu`,`infomenu`,`othermenu`,`owner`,`gcbot`,`tq`,`sewabot`]
               listmenuu = [`Menu Group`,`Photo Oky`,`Ephoto Menu`,`Random Image`,`Nsfw Anime`,`Movie&Story`,`18+ Menu`,`RandomText`,`Islam Menu`,`Wibu Menu`,`Sticker Menu`,`Owner Command`,`Game Menu`,`For Fun Menu`,`Downloader`,`Info Menu`,`Menu Lainnya`,`OwnerBot`,`Official Group`,`Thanks To`,`Rent this Bot`]
               nombor = 1
               startnum = 0
...
*「 Made-With-By-ʙᴏᴛᴢᴢ ᴍᴇᴇ 」*`
	    ...
	    // console.log(e)
            setTimeout( () => {
			ikyy.updatePresence(from, Presence.composing)
			reply(`*Terimakasih Telah Terdaftar Di ʙᴏᴛᴢᴢ ᴍᴇᴇ*`)
		}, 2000)
        break
case 'sfire':
{
...
//------------------< Premium >-------------------
       ...
       case 'buypremium':
       case 'sewabot':
              gopeynya = 'https://telegra.ph/file/293ab6f7edbc979cddace.jpg'
...
┃⬡ SEWA 5K : BULAN
┃⬡ SEWA 10K : PERMANENT
┃⬡ SEWA 15K : PERMANENT + 2 GROUP
┃⬡ PREMIUM : 10K
┃⬡ SEWA PERMANENT + PREM : 20K - 25K
┗━━⬣

┏━━⬣ PRICE LIST 2
┃⬡ JADI BOT FREE : 30 MENIT
┃⬡ JADI BOT + OWNER : 20K
┃⬡ SC BOT TANYA OWNER
┗━━⬣
...
SISTEM : BOT MASUK - BUKTI TF - DONE

NOTE : BOT ON 24 JAM KARNA DI RUN HEROKU
`
  buttons = [{buttonId: `${prefix}owner`,buttonText:{displayText: `OWNER`},type:1},{buttonId: `${prefix}payment`,buttonText:{displayText: `PAYMENT`},type:1}]
      ...
      break
      case 'ovo':
              gopeynya = 'https://telegra.ph/file/f2483bb5b4b45962f13b1.jpg'
            buff = await getBuffer(gopeynya)
            teksnya = `Scan Qris Di Atas Untuk Pembayaran Melalui Ovo
            `
  buttons = [{buttonId: `${prefix}owner`,buttonText:{displayText: `OWNER`},type:1},{buttonId: `${prefix}gcbot`,buttonText:{displayText: `GROUP BOT`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'Made-With-By-ʙᴏᴛᴢᴢ ᴍᴇᴇ', imageMessage: imageMsg,
              contentText: teksnya,buttons,headerType:4}
              prep = await ikyy.prepareMessageFromContent(from,{buttonsMessage},{quoted: freply})
      ...
      break
      case 'dana':
              gopeynya = 'https://telegra.ph/file/b3ba53f0c62d01f5f44bd.jpg'
            buff = await getBuffer(gopeynya)
            teksnya = `Scan Qris Di Atas Untuk Pembayaran Melalui Dana
            `
  buttons = [{buttonId: `${prefix}owner`,buttonText:{displayText: `OWNER`},type:1},{buttonId: `${prefix}gcbot`,buttonText:{displayText: `GROUP BOT`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'Made-With-By-ʙᴏᴛᴢᴢ ᴍᴇᴇ', imageMessage: imageMsg,
      ...
      break
      case 'gopay':
              gopeynya = 'https://telegra.ph/file/715022575e2498342a61c.jpg'
            buff = await getBuffer(gopeynya)
            teksnya = `Scan Qris Di Atas Untuk Pembayaran Melalui Gopay
            `
  buttons = [{buttonId: `${prefix}owner`,buttonText:{displayText: `OWNER`},type:1},{buttonId: `${prefix}gcbot`,buttonText:{displayText: `GROUP BOT`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'Made-With-By-ʙᴏᴛᴢᴢ ᴍᴇᴇ', imageMessage: imageMsg,
      ...
      case 'patner':
               list = []
               listmenu = [`bara`,`ryzer`,`hans`,`budi`,`iki`,`galang`,`putra`,`dhani`,`xinz`,`adi`,`reza`,]
               listmenuu = [`Bara Bot`,`Ryzer Bot`,`Hans Bot`,`The Sad Boy 0.1`,`Kurumi Bot`,`Night Bot`,`PutraXd Ofc`,`Bot Dhani`,`Xinz Bot`,`Adi Official`,`Reza Bot`,]
               nombor = 1
               startnum = 0
               for (let x of listmenu) {
               const yy = {title: 'menu ke' + nombor++,
               ...
               buttons = [{buttonId: '!infoig',buttonText:{displayText:'INSTAGRAM'},type:1},{buttonId:'!infoyt',buttonText:{displayText:'YOUTUBE'},type:1}]
   ...
   case 'reza': 
      ...
      case 'payment':
               list = []
               listmenu = [`ovo`,`dana`,`gopay`,]
               listmenuu = [`OVO`,`DANA`,`GOPAY`,]
               nombor = 1
               startnum = 0
               for (let x of listmenu) {
               const yy = {title: 'menu ke' + nombor++,
               ...
               listmsg(from, `Silahkan Pliih List Pembayaran Disini!\nHarap Chat Owner Sebelum Scan Qris`, `  `, list)
               break  
   case 'tq':
        case 'info':
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
textny = 'https://telegra.ph/file/4e3581f3ae06bfa621247.jpg'
...
━━━━━━━ •♬• ━━━━━━━
`
ikyy.sendMessage(from, { contentText: `${menuny}`, footerText: 'Made-With-By-ʙᴏᴛᴢᴢ ᴍᴇᴇ', buttons: [{ buttonId: `!patner`, buttonText: { displayText: 'ANJAY :V' }, type: 1 } ],  headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: buff, contextInfo: {mentionedJid: [sender]}}}, 'buttonsMessage')
              break    
//------------------< Sticker Cmd >-------------------
       case 'addcmd': 
       case 'setcmd':
...
//------------------< Ingfo Bot >-------------------
      case 'runtime':
       ...
       case 'sc': 
       case 'src':
              reply(`Bot ini menggunakan sc : https://github.com/Nurbara/Bara-V1`)
              break
      case 'ping':
      case 'speed':
              timestampe = speed();
...
//------------------< Owner >-------------------
      ...
      case 'broadcast':
             ...
             for (let _ of anu) {
             ikyy.sendMessage(_.jid, bc, image, {quoted:freply,caption: `*「 Broadcast 」*\n\n${body.slice(4)}`})
}
...
case 'caripesan':  //by ANU TEAM
       ...
       case 'bugreport':
              ...
              ikyy.sendMessage('6283174508962@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
              break
       case 'readall':
...
//------------------< Menunya Bang:v >-------------------
      case 'infoig':
             reply(`Jangan Lupa Follow Ig Owner Ya : https://www.instagram.com/lampu_philips267`)
             break
      case 'infoyt':
             reply(` Jangan Lupa Subscribe Yt Owner Ya :\n https://youtube.com/channel/BotzzMeeOFC`)
             break
      case 'gcbot':
             reply('https://chat.whatsapp.com/IlUxptBYvl8Edpq90teOAa\nJangan Lupa Join Ya Kak')
             break
